...
public class Propbank_old {
     ...
     */
    public static Propbank_old getPropbank() {
        if (p == null) {
            p = new Propbank_old();
        }
        return p;
    ...
    private ArrayList<ArrayList<String>> read(String file, int n) {
        try {
            ...
            Logger.getLogger(Propbank_old.class.getName()).log(Level.SEVERE, null, ex);
